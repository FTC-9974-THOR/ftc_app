 ...
 */
@TeleOp(name="KI4 Competition")
public class KI4CompetitionMode extends OpMode {
    ...
    public void loop() {
        if (gamepad1.left_bumper) {
            rb.move(-gamepad1.right_stick_x, -gamepad1.right_stick_x, 0);
        } else {
            rb.move(-gamepad1.right_stick_x, -gamepad1.right_stick_y, -0.5 * gamepad1.left_stick_x);
        }
